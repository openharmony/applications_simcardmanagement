...
function build {
    ...
    # cp TempSDKs/XXX.d.ts $HM_SDK_HOME/HarmonyOS-NEXT-DB*/hms/ets/api
    # 从SDK拷贝签名jar包
    cd ${PROJECT_PATH}

    ls -al $HM_SDK_HOME/HarmonyOS-NEXT-DP1/openharmony/toolchains/lib/
    cp $HM_SDK_HOME/HarmonyOS-NEXT-DP1/openharmony/toolchains/lib/hap-sign-tool.jar signature/hap-sign-tool.jar
    ...
    cp entry/build/default/outputs/default/entry-default-signed.hap entry/build/default/outputs/default/SimCardManagement.hap
